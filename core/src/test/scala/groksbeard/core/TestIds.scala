...
given CanEqual[TaskId, String]           = CanEqual.canEqualAny
given CanEqual[String, TaskId]           = CanEqual.canEqualAny
...
given Conversion[String, TaskId]         = TaskId(_)
given Conversion[String, TaskKind]       = TaskKind.fromWire(_)
given Conversion[String, TaskStatus]     = TaskStatus.fromWire(_)
