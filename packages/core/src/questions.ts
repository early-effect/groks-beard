...
export class AskUserQuestionRequest
  extends Schema.Class<AskUserQuestionRequest>("AskUserQuestionRequest")({
    sessionId: Schema.optionalKey(Schema.String),
    questions: Schema.NonEmptyArray(AgentQuestion),
  })
{}

export class AskUserQuestionAnswer
  extends Schema.Class<AskUserQuestionAnswer>("AskUserQuestionAnswer")({
